...
<script type="text/javascript">
	function exitSys() {
		...
		if (flag) {
			window.top.open('/BusSystem/index.jsp', '_parent','', '');
			window.top.close();
		}
	...
	function edit(){
		window.location("/admin/bus/add.jsp");
	}
</script>
</HEAD>
<body>
...
%>
	...
	<table width="100%" height="70%" border="0" cellspacing="0"
		...
		<tr>
			<td width="100%"
				background="${pageContext.request.contextPath}/images/logo.jpg">
			</td>
		</tr>
	</table>
								...
								<tr>
									...
									<td width="155" valign="bottom"
										...
										<font color="blue"><a href="javascript:void(0)"
											...
											<a target="mainFrame" href="${pageContext.request.contextPath }/editPwdServlet?userID=${userID } ">修改密码</a></font></td>
